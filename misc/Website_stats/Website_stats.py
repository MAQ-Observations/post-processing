...
user_reg_file = 'user-registration-user-update-2025-12-16.csv'
oper_data_file = 'operational-data-2025-12-16.csv'
data_figs_file = 'data-figures-2025-12-16.csv'
data_down_file = 'data-downloads-2025-12-16.csv'
